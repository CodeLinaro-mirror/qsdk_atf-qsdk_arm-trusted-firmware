...
#define	PLAT_QTI_G0_IRQ_PROPS		\
	...
	INTR_PROP_DESC(QTISECLIB_INT_ID_NON_SEC_WDOG_BITE, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
        INTR_PROP_DESC(QTISECLIB_INT_ID_CONFIG_NOC_ERROR_1, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
        INTR_PROP_DESC(QTISECLIB_INT_ID_CONFIG_NOC_ERROR_2, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_GEM_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_SYSTEM_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_AGGR_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(QTISECLIB_INT_ID_NSS_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL), \
        INTR_PROP_DESC(QTISECLIB_INT_ID_XPU_VIOLATION, GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0, \
			GIC_INTR_CFG_LEVEL)
